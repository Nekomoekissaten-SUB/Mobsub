...
public class Clean
{
    public struct CleanAssArgs
    {
        ...
        public bool renameTitle;
        public bool addLayoutRes;
        public bool deleteFanhuaji;

        // Styles
        public bool dropDuplicateStyles;

        // Events
        public bool dropUnusedStyles;
        public bool processEvents;
        public bool rmMotionGarbage;   // AegisubExtradata

        // Styles and Events
        public bool fixStyleName;
    }
    ...
    public static void CleanAss(AssData data, ReadOnlySpan<char> assFileName, CleanAssArgs args, out string msg, out bool untouched)
    {
        ...
        if (args.processEvents || args.dropUnusedStyles)
        {
            ...
            if (data.Events != null)
            {
                ...
                {
                    if (evt.IsDialogue) usedStyles.Add(evt.Style);
                }
            }
            ...
            // process events
            if (args.processEvents && data.Events != null && data.Events.Collection.Count > 0)
            {
                ...
                {
                    var evt = data.Events.Collection[i];
